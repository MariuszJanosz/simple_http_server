...
typedef enum {
    ...
    //it might happen for example when body is longer that Content-Length
...
#define PARSING_FINE 0 
#define PARSING_BROKEN_CLOSE_CONNECTION 1
#define REQUEST_PROCESSING_FINE 2
#define ROUTING_FINE 3
...
#define HTTP_STATUS_FAILED_DEPENDANCY 424

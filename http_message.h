...
typedef enum {
    ...
    HTTP_STATUS_PAYLOAD_TO_LARGE = 413,
    HTTP_STATUS_URI_TO_LONG = 414,
    HTTP_STATUS_UNSUPORTED_MEDIA_TYPE = 415,
    ...
    HTTP_STATUS_BAD_GEATWAY = 502,
    HTTP_STATUS_SERVICE_UNAVAILABLE = 503,
    HTTP_STATUS_GEATWAY_TIMEOUT = 504,
